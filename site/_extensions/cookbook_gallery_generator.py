...
def main(app):
    ...
    submit_btn_link = 'https://github.com/ProjectPythiaCookbooks/projectpythiacookbooks.github.io/issues/new?assignees=&labels=resource-gallery-submission&template=update-cookbook.md&title='
